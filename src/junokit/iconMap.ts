...
export type LibraryType = keyof typeof prefixMap;
export type IconNameType = keyof typeof iconMap;

export const getIconName = (preformattedName: IconNameType, library: LibraryType): string => {
  ...
  let reactIconsName = libraryName.replace(/-([a-z])/g, (_, letter) => letter.toUpperCase());

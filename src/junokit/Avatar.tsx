...
type AvatarProps = {
  ...
  bgColor?:
    ...
    | "info"
    | string;
  size?: "20px" | "24px" | "28px" | "32px" | "40px" | "48px";
...
export default function Avatar({
  ...
  const fontColor =
    bgColor?.startsWith("base") && !(bgColor == "base-content" || bgColor == "base-700")
      ? "text-base-content"
      : `text-base-0`;

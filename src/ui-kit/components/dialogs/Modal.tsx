...
export default function Modal({
    ...
    const classes = `flex flex-col min-h-[120px] relative items-stretch justify-start mx-auto ${shadowStyle} ${modalBg} ${gapStyles} ${borderStyles} ${paddingStyles} ${cornerStyles}`
    ...
    return (
        ...
        style={{
            ...
            {closeButton && 
            <div className={`absolute right-2 top-2 z-50 transition-all rounded-lg`}>
                <ButtonIcon icon='close' size="small" color='base-700' style={"ghost"}
onClick={onClose}
                />
            </div>}
            {children}
